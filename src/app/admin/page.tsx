      ...
      <header className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            <Link href="/admin/restaurants" className="text-sm text-black hover:text-gray-600">
              Restaurants
            </Link>
            <Link href="/admin/orders" className="text-sm text-black hover:text-gray-600">
              Orders
            </Link>
            <Link href="/admin/settings" className="text-sm text-black hover:text-gray-600">
              Settings
            </Link>
            <Link 
              href="/profile" 
